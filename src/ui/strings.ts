...
export const applyStaticUi = (root: Document = document): void => {
  ...
  const textBySelector: Readonly<Record<string, string>> = {
    ...
    '#choose-import-file .io-action-label': STATIC_UI.openFile,
    '#export-html .io-action-label': STATIC_UI.downloadHtml,
    '#copy-html .io-action-label': STATIC_UI.copyHtml,
    '#copy-text .io-action-label': STATIC_UI.copyText,
    '#load-example .io-action-label': STATIC_UI.loadExample,
    '#new-document .io-action-label': STATIC_UI.newDocument,
